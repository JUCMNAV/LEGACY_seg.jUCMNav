...
public class UrncorePackageImpl extends EPackageImpl implements UrncorePackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDynamicResponsibility_ArrowLength(), ecorePackage.getEIntegerObject(), "arrowLength", null, 0, 1, DynamicResponsibility.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
