...
public abstract class ComponentElementImpl extends UCMmodelElementImpl implements ComponentElement {
    ...
    public EList getCompRefs() {
        if (compRefs == null) {
            compRefs = new EObjectWithInverseResolvingEList(SpecificationComponentRef.class, this, UrncorePackage.COMPONENT_ELEMENT__COMP_REFS, UrncorePackage.SPECIFICATION_COMPONENT_REF__COMP_DEF);
        }
        return compRefs;
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class baseClass) {
        if (baseClass == SpecificationComponent.class) {
            switch (derivedFeatureID) {
                case UrncorePackage.COMPONENT_ELEMENT__LINE_COLOR: return UrncorePackage.SPECIFICATION_COMPONENT__LINE_COLOR;
                case UrncorePackage.COMPONENT_ELEMENT__FILL_COLOR: return UrncorePackage.SPECIFICATION_COMPONENT__FILL_COLOR;
                case UrncorePackage.COMPONENT_ELEMENT__FILLED: return UrncorePackage.SPECIFICATION_COMPONENT__FILLED;
                case UrncorePackage.COMPONENT_ELEMENT__COMP_REFS: return UrncorePackage.SPECIFICATION_COMPONENT__COMP_REFS;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass) {
        if (baseClass == SpecificationComponent.class) {
            switch (baseFeatureID) {
                case UrncorePackage.SPECIFICATION_COMPONENT__LINE_COLOR: return UrncorePackage.COMPONENT_ELEMENT__LINE_COLOR;
                case UrncorePackage.SPECIFICATION_COMPONENT__FILL_COLOR: return UrncorePackage.COMPONENT_ELEMENT__FILL_COLOR;
                case UrncorePackage.SPECIFICATION_COMPONENT__FILLED: return UrncorePackage.COMPONENT_ELEMENT__FILLED;
                case UrncorePackage.SPECIFICATION_COMPONENT__COMP_REFS: return UrncorePackage.COMPONENT_ELEMENT__COMP_REFS;
                default: return -1;
            }
        }
