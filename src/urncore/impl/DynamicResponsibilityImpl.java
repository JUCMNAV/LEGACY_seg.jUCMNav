...
public class DynamicResponsibilityImpl extends ResponsibilityImpl implements DynamicResponsibility {
	 ...
	 * @ordered
	 */
	protected static final Integer ARROW_LENGTH_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Integer arrowLength = ARROW_LENGTH_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setArrowLength(Integer newArrowLength) {
		Integer oldArrowLength = arrowLength;
	...
	public void eSet(EStructuralFeature eFeature, Object newValue) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UrncorePackage.DYNAMIC_RESPONSIBILITY__TO_PATH:
				...
				return;
			case UrncorePackage.DYNAMIC_RESPONSIBILITY__ARROW_LENGTH:
				setArrowLength((Integer)newValue);
				return;
			case UrncorePackage.DYNAMIC_RESPONSIBILITY__POOL:
	...
	public boolean eIsSet(EStructuralFeature eFeature) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UrncorePackage.DYNAMIC_RESPONSIBILITY__ARROW_LENGTH:
				return ARROW_LENGTH_EDEFAULT == null ? arrowLength != null : !ARROW_LENGTH_EDEFAULT.equals(arrowLength);
			case UrncorePackage.DYNAMIC_RESPONSIBILITY__POOL:
				return pool != null;
		}
