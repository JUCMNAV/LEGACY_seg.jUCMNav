...
public final class DynamicRespKind extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
    public static final DynamicRespKind MOVE_LITERAL = new DynamicRespKind(MOVE, "Move", "Move");
	 ...
	 * @ordered
	 */
    public static final DynamicRespKind MOVE_STAY_LITERAL = new DynamicRespKind(MOVE_STAY, "MoveStay", "MoveStay");
	 ...
	 * @ordered
	 */
    public static final DynamicRespKind CREATE_LITERAL = new DynamicRespKind(CREATE, "Create", "Create");
	 ...
	 * @ordered
	 */
    public static final DynamicRespKind COPY_LITERAL = new DynamicRespKind(COPY, "Copy", "Copy");
	 ...
	 * @ordered
	 */
    public static final DynamicRespKind DESTROY_LITERAL = new DynamicRespKind(DESTROY, "Destroy", "Destroy");
	...
	/**
	 * Returns the '<em><b>Dynamic Resp Kind</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 */
    public static DynamicRespKind get(String literal) {
	 ...
	 * @generated
	 */
	public static DynamicRespKind getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DynamicRespKind result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Dynamic Resp Kind</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 */
	 ...
	 * @generated
	 */
	private DynamicRespKind(int value, String name, String literal) {
