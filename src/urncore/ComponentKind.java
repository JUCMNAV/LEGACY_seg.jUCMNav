...
public final class ComponentKind extends AbstractEnumerator {
     ...
     * @ordered
     */
    public static final ComponentKind TEAM_LITERAL = new ComponentKind(TEAM, "Team");
     ...
     * @ordered
     */
    public static final ComponentKind OBJECT_LITERAL = new ComponentKind(OBJECT, "Object");
     ...
     * @ordered
     */
    public static final ComponentKind PROCESS_LITERAL = new ComponentKind(PROCESS, "Process");
     ...
     * @ordered
     */
    public static final ComponentKind AGENT_LITERAL = new ComponentKind(AGENT, "Agent");
     ...
     * @ordered
     */
    public static final ComponentKind ACTOR_LITERAL = new ComponentKind(ACTOR, "Actor");
     ...
     * @ordered
     */
    public static final ComponentKind OTHER_LITERAL = new ComponentKind(OTHER, "Other");
