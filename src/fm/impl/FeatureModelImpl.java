...
public class FeatureModelImpl extends COREFeatureModelImpl implements FeatureModel {
		...
		if (grlspec != null && grlspec.eIsProxy()) {
			...
			if (grlspec != oldGrlspec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FmPackage.FEATURE_MODEL__GRLSPEC, oldGrlspec, grlspec));
			}
		}
		return grlspec;
	}
	...
	public NotificationChain basicSetGrlspec(GRLspec newGrlspec, NotificationChain msgs) {
		...
		grlspec = newGrlspec;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FmPackage.FEATURE_MODEL__GRLSPEC, oldGrlspec, newGrlspec);
	...
	public void setGrlspec(GRLspec newGrlspec) {
		if (newGrlspec != grlspec) {
			...
			if (grlspec != null)
				msgs = ((InternalEObject)grlspec).eInverseRemove(this, GrlPackage.GR_LSPEC__FEATURE_MODEL, GRLspec.class, msgs);
			if (newGrlspec != null)
