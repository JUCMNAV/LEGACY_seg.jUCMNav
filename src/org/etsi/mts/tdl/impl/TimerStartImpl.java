...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Timer Start</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.etsi.mts.tdl.impl.TimerStartImpl#getPeriod <em>Period</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TimerStartImpl extends TimerOperationImpl implements TimerStart {
	/**
	...
	protected EClass eStaticClass() {
		return TdlPackage.Literals.TIMER_START;
	}
	...
	public void setPeriod(Time newPeriod) {
		if (newPeriod != period) {
			...
			if (newPeriod != null)
				msgs = ((InternalEObject)newPeriod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TdlPackage.TIMER_START__PERIOD, null, msgs);
			msgs = basicSetPeriod(newPeriod, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TdlPackage.TIMER_START__PERIOD, newPeriod, newPeriod));
	}
