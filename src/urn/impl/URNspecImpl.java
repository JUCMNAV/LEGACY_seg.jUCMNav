...
public class URNspecImpl extends EObjectImpl implements URNspec {
     ...
     * @ordered
     */
    protected UCMspec ucmspec = null;
     ...
     * @ordered
     */
    protected GRLspec grlspec = null;
     ...
     * @ordered
     */
    protected URNdefinition urndef = null;
    ...
    protected EClass eStaticClass() {
        return UrnPackage.eINSTANCE.getURNspec();
    }
    ...
    public void setUcmspec(UCMspec newUcmspec) {
        if (newUcmspec != ucmspec) {
            ...
            if (newUcmspec != null)
                msgs = ((InternalEObject)newUcmspec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UrnPackage.UR_NSPEC__UCMSPEC, null, msgs);
    ...
    public void setGrlspec(GRLspec newGrlspec) {
        if (newGrlspec != grlspec) {
            ...
            if (newGrlspec != null)
                msgs = ((InternalEObject)newGrlspec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UrnPackage.UR_NSPEC__GRLSPEC, null, msgs);
    ...
    public void setUrndef(URNdefinition newUrndef) {
        if (newUrndef != urndef) {
            ...
            if (newUrndef != null)
                msgs = ((InternalEObject)newUrndef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UrnPackage.UR_NSPEC__URNDEF, null, msgs);
    ...
    public EList getUrnLinks() {
        if (urnLinks == null) {
            urnLinks = new EObjectContainmentEList(URNlink.class, this, UrnPackage.UR_NSPEC__URN_LINKS);
        }
        return urnLinks;
    }
