 ...
 *
 */
public abstract class AbstractSpecificationDiagramXYLayoutEditPolicy extends XYLayoutEditPolicy {
    ...
    protected Command handleMoveLabel(EditPart child, Object constraint) {
        ...
        if (((IStructuredSelection) getHost().getViewer().getSelection()).toList().size() == 1) {
            ...
            if (label instanceof ComponentLabel) {
                SpecificationComponentRef component = (SpecificationComponentRef) (((LabelEditPart) child).getURNmodelElement());
    ...
    protected Command handleMoveResizeComponentRef(EditPart child, Object constraint) {
        ...
        SpecificationComponentRef compRef = (SpecificationComponentRef) child.getModel();
