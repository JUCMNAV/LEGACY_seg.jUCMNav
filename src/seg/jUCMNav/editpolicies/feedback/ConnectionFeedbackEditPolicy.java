...
/**
 * On mouse hover of node connection, it becomes thicker so that we can click on
 * it more easily. Change the connection's color when selected.
 * 
 * @author jkealey
 */
public class ConnectionFeedbackEditPolicy extends SelectionEditPolicy {
	...
	private PolylineConnection getFigure() {
		return (PolylineConnection) ((AbstractConnectionEditPart) this
				.getHost()).getFigure();
	}
