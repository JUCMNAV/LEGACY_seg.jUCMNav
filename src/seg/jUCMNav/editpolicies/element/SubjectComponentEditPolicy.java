...
import seg.jUCMNav.model.commands.delete.DeleteSubjectCommand;
 ...
 * @author Jordan
 */
public class SubjectComponentEditPolicy extends ComponentEditPolicy {
    ...
    protected Command getDeleteCommand(GroupRequest request) {
    	 ( (SubjectEditPart)	getHost()).getASDiagramEditPart().refreshVisuals();
        Subject subject= (Subject) getHost().getModel();
       ...
       DeleteSubjectCommand deleteCommand = new DeleteSubjectCommand(((SubjectEditPart)getHost()).getDiagram().getUrndefinition().getUrnspec(),subject,((SubjectEditPart)getHost()).getDiagram());
       editor = (UCMNavMultiPageEditor) PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().getActiveEditor();
