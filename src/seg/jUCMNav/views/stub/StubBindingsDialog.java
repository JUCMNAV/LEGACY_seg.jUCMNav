...
/**
 * The stub bindings dialog is the only way one can manage a stub's bindings:
 * this stub can load which maps and how its in/out connections mapped to
 * start/end points in the plugin map.
 * 
...
public class StubBindingsDialog extends Dialog implements Adapter {
	...
	/**
	 * Updates the curretly selected plugin binding with what is in the text
	 * boxes.
	 * 
	 * @param refresh
	...
	/**
	 * Handle when the user checks an item in the map list table. Depending if
	 * the stub is dynamic or not the function will add a new plugin to the stub
	 * or replace the last one with the new map selected. The add bindings view
	 * will get updated with the new selected plugin.
	 * 
	 * @param item
	...
	/**
	 * Handle the event when the user click on a tree item. This will update the
	 * view for adding bindings and will update the delete button.
	 * 
	 * @param source
	 ...
	 * Refreshes the map list and bindings tree.
	 * 
	 * @param command
	 ...
	 * 
	 * @param stub
	 *            The stub beeing selected. null if we don't have any Stub
	 *            selected.
	 */
	...
	/**
	 * Open the window with a predefined stub. This is the official way to open
	 * this dialog.
	 * 
	 * @param newStub
	...
	/**
	 * Called before closing this dialog. Dispose all images and remove this
	...
	/**
	 * Refresh the map list display in the combobox listing the possible maps to
	 * plugin to.
	 */
	...
	/**
	 * Refresh with the correct info the tree of the bindings of this stub. The
	 * tree will build itself with the following structure: <br>
	 * Bindings <br>
	 * |-+ Stub <->Map <br>| |-+ In bindings <br>| | |-+ StartPoint
	 * <->EmptyPoint <br>| |-+ Out bindings <br>| | |-+ EndPoint <->EmptyPoint
	 * <br>
	 */
	 ...
	 * @return True if the StartPoint is contained in an InBinding of the
	...
	/**
	 * Utility method to know if a NodeConnection is binded in an InBinding with
	 * the selected Stub
	 * 
	 * @param con
	 *            The NodeConnection you want to know is binded or not.
	 * @return True if the NodeConnection is contained in an InBinding of the
	 *         selected Stub PluginBinding. Else return false.
	 */
