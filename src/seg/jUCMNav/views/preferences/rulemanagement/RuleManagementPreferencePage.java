...
public abstract class RuleManagementPreferencePage  extends PreferencePage implements IWorkbenchPreferencePage, SelectionListener, FocusListener{
	 ...
	 * @param item  the specified tree item on which a check/uncheck will be put
	...
	/**
	 * Put a check mark on all groups based on their rules.
	 * If all rules of a group are checked, the group is put on checked mark. 
	 * If only some of rules of a group are checked, the group is put on a greyed mark. 
	 * If no rules of a group is checked, the group is put on an unchecked mark.
	 */
