...
public abstract class TextChangeHelper implements Listener {
     ...
     * avoid unwanted lifecycle events.
     * 
...
//        control.addListener(SWT.Modify, this);
    ...
    /**
     * Registers this helper with the given control to listen for the Enter key. When Enter is pressed, the change is considered done (this is only appropriate
     * for single-line Text widgets).
     */
