...
/***
 * The search page registered in CTRL-H dialog. Heavily based on FileSearchPage with some elements hidden for the time being. We removed the Replace functionality. 
 * Later, we might re-add these elements into the dialog. (Filename filters, scopes, etc.)
 * 
 * 
 * @author jkealey
 *
...
public class UrnSearchPage extends DialogPage implements ISearchPage
{
	...
	private SearchPatternData getPatternData()
	{
		...
		match = new SearchPatternData(getPattern(), isCaseSensitive(), fIsRegExCheckbox.getSelection(), getExtensions(), getContainer().getSelectedScope(), getContainer().getSelectedWorkingSets());
