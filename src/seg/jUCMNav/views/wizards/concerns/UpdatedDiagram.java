...
/**
 * an UpdatedDiagram wraps a IURNDiagram in order to keeps track of the changes 
...
public class UpdatedDiagram {
	...
	/**
	 * @param original diagram to be wrapped (the diagram must already exist)
	 */
	 ...
	 * @param updatedConcern to be assigned to this diagram
	 ...
	 * @param sync controls synchronization of UpdatedConcerns and UpdatedDiagrams; if true, synchronization occurs; if false, synchronization does not occur
	...
	/**
	 * @param diagrams list containing the diagram from which to remove the concern
	...
	/**
	 * @param diagram for which to find its wrapper object (UpdatedDiagram)
