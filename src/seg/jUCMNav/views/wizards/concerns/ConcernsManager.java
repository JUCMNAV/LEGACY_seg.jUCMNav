...
public class ConcernsManager extends Wizard {
	 ...
	 * Gets the updates from UpdatedConcern/UpdatedDiagram and creates the 
	 * commands to change the URN model according to the updates.
	 */
	...
	/**
	 * This method is called when the 'Cancel' button is pressed in the wizard. 
	 * Ensures that the temporary UpdatedConcerns/UpdatedDiagrams are disposed.
	 */
	 ...
	 * @param workbench the current workbench we are working with
	 * @param urn the URNspec
	 * @param defaultSelected the URNmodelElement currently selected
	 */
