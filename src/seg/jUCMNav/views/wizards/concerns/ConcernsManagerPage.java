...
public class ConcernsManagerPage extends WizardPage {
	 ...
	 * @param selectionConcerns the list of concerns in the URN model
	 * @param selectionDiagrams the list of IURNDiagrams in the URN model
	 * @param defaultSelected the URNmodelElement currently selected (any element other than Concerns or IURNDiagrams are ignored)
	 */
	...
	/**
	 * refreshes the dynamic content of the widgets (removes listeners before doing so
	 * and adds them back when finished)
	 */
