...
/**
 * an UpdatedConcern wraps a Concern in order to keeps track of the changes 
 * as needed for the {@link ConcernsManagerPage};
 * does not change anything in the URN model (i.e. the original is not altered)
 * @author gunterm
 */
public class UpdatedConcern {
	...
	/**
	 * @param original concern to be wrapped (the concern must already exist)
	 */
	...
	/**
	 * @param description with which to update the concern
	 */
	...
	/**
	 * @param name with which to update the concern
	 */
	...
	/**
	 * this should only be called from UpdatedDiagram once a concern was assigned to the diagram
	 * (keeps the MODEL synchronized)
	 * @param updatedDiagram to which this concern is to be assigned
	...
	/**
	 * this should only be called from UpdatedDiagram once a concern was removed from the diagram
	 * (keeps the MODEL synchronized)
	 * @param updatedDiagram from which the concern is to be removed
	...
	/**
	 * checks if the updatedSpecDiagrams list has already been initialized;
	 * if not, initializes the updatedSpecDiagrams list with the list from the original
	 */
	...
	/**
	 * checks if the updatedSpecDiagrams list is exactly the same as the original list (ordering does not matter)
	 * if it is, resets updatedSpecDiagrams to null (which indicates that the original list did not change)
	 */
	...
	/**
	 * @param concern for which to find its wrapper object (UpdatedConcern)
