 ...
 */
public class DivisionOfLabourFigure extends Label implements LabelElementFigure {
...
ASDiagram asdiagram;
 ...
 // default sizes
    ...
    public DivisionOfLabourFigure(ASDspec asdSpec, DivisionOfLabour model,ASDiagram asdiagram) {
