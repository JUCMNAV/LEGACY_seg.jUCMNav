...
public class ChangeWaitPlaceTypeAction extends URNSelectionAction {
	...
	public static final String[] WAITINGPLACE_TYPES = new String[] { Messages.getString("ChangeWaitPlaceTypeAction.Transient"), Messages.getString("ChangeWaitPlaceTypeAction.Persistent")}; //$NON-NLS-1$ //$NON-NLS-2$
