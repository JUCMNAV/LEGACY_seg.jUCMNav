...
public class ChangeComponentTypeAction extends URNSelectionAction {
	...
	public static final String[] COMPONENT_TYPES = new String[] { Messages.getString("ChangeComponentTypeAction.Team"), Messages.getString("ChangeComponentTypeAction.Object"), Messages.getString("ChangeComponentTypeAction.Process"), Messages.getString("ChangeComponentTypeAction.Agent"), Messages.getString("ChangeComponentTypeAction.Actor"), Messages.getString("ChangeComponentTypeAction.Other")}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
	public static final ComponentKind[] COMPONENT_KINDS = new ComponentKind[] {ComponentKind.TEAM_LITERAL, ComponentKind.OBJECT_LITERAL, ComponentKind.PROCESS_LITERAL, ComponentKind.AGENT_LITERAL, ComponentKind.ACTOR_LITERAL, ComponentKind.OTHER_LITERAL}; 
	...
	protected boolean calculateEnabled() {
		...
		case SelectionHelper.COMPONENTREF:
			...
			if (comp.getKind()==null) return true;
	...
	/**
	 * Returns the appropriate convert command, given the
	 * current selection.
	 */
