...
public class NavigateHyperlinkAction extends SelectionAction
{
	...
	/**
	 * True if we have selected a valid URNmodelElement with hyperlink. 
	...
	/**
	 * Launches a new browser window with the hyperlink of the selected URN model element.
	 * No command on the stack needed.
	 * 
	 */
	public void run() {
		...
		IWebBrowser browser;
		try {
			browser = browserSupport.createBrowser(WorkbenchBrowserSupport.AS_EDITOR | WorkbenchBrowserSupport.LOCATION_BAR | IWorkbenchBrowserSupport.NAVIGATION_BAR, null, null, null);
