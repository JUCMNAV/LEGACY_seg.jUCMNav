...
//			}
	 ...
	 * 
	 * @see
	 * seg.jUCMNav.extensionpoints.IURNImport#importURN(java.io.FileInputStream,
	 * urn.URNspec)
	 */
	// public URNspec importURN(FileInputStream fis, URNspec urn, Vector
	// autolayoutDiagrams) throws InvocationTargetException {
	// 
	// URNunmarshaller um = new URNunmarshaller();
	// um.URNunmarshallerMain(fis,autolayoutDiagrams);
	// return null;
	// }
	/*
	 * this.urn = (URNspec)EcoreUtil.copy(urn); this.map = new HashMap();
	 * this.autolayoutDiagrams = autolayoutDiagrams;
	 * 
	 * 
	 * // Create a Digester instance which has been initialised with // rules
	 * loaded from the specified file.
	 * //C:\\Users\\Yan\\workspace\\seg.jUCMNav\\
	 * src\\seg\\jUCMNav\\importexport\\z151\\ //String RULES_FILE =
	 * "/seg/jUCMNav/importexport/z151/z151DigesterRules.xml";
	 * 
	 * System.out.println("after"); // String RULES_FILE =
	 * "/seg/jUCMNav/importexport/z151/xmlrules.xml"; // URL rulesURL =
	 * ImportZ151.class.getResource(RULES_FILE); // //URL rulesURL =
	 * ClassLoader.getSystemResource(RULES_FILE); // if (rulesURL == null) { //
	 * System.out.println("Unable to find rules file." ); // System.exit(-1); //
	 * }else{ // System.out.println("I'm here"); //
	 * System.out.println("digester rules: "+rulesURL.getPath()); // } //
	 * Digester d = DigesterLoader.createDigester(rulesURL); // // Prime the
	 * digester stack with an object for rules to // // operate on. Note that it
	 * is quite common for "this" // // to be the object pushed. //
	 * d.toString(); // d.push(this.urn); // d.toString(); // // // Process the
	 * input file. // try { // d.parse(fis); // } // catch(java.io.IOException
	 * ioe) { // System.out.println("Error reading input file:" +
	 * ioe.getMessage()); // System.exit(-1); // } //
	 * catch(org.xml.sax.SAXException se) { //
	 * System.out.println("Error parsing input file:" + se.getMessage()); //
	 * System.exit(-1); // } return this.urn; }
	 * 
	 * / (non-Javadoc)
	 * 
	 * @see seg.jUCMNav.extensionpoints.IURNImport#importURN(java.lang.String,
