...
public abstract class MHandler {
	...
	static {
		...
		// ourClass2Conv.put( grl.impl.GRLmodelElementImpl.class, new
		// GRLmodelElementMHandler());
		// ourClass2Conv.put( grl.impl.GRLNodeImpl.class, new
		// GRLNodeMHandler());
		...
		// ourClass2Conv.put( IURNConnectionImpl.class, new
		// IURNConnectionMHandler());
		...
		// ourClass2Conv.put( urncore.impl.UCMmodelElementImpl.class, new
		// UCMmodelElementMHandler());
		...
		// ourClass2Conv.put( urncore.impl.URNmodelElementImpl.class, new
	...
	protected DecompositionType getDecompositionType(grl.DecompositionType typeJ) {
		...
		case grl.DecompositionType.OR:
			return seg.jUCMNav.importexport.z151.generated.DecompositionType.IOR; // DecompositionType:
																					// jUCMNav
																					// has
																					// OR,
																					// but
	...
	protected seg.jUCMNav.importexport.z151.generated.IntentionalElementType getIntentionalElementType(grl.IntentionalElementType typeJ) {
		...
		case grl.IntentionalElementType.INDICATOR:
			return seg.jUCMNav.importexport.z151.generated.IntentionalElementType.TASK;
			// IntentionalElementType: jUCMNav has Indicator, but Z151 has
			// Belief
