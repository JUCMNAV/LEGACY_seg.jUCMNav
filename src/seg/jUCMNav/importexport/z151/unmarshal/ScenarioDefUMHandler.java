	...
	public Object handle(Object o, Object target, boolean isFullConstruction) {
		...
		if (isFullConstruction) {
			...
			for (JAXBElement<Object> item : elemZ.getEndPoints()) {
				...
				scenarioEndPoint.setMandatory(false); // set to default
				scenarioEndPoint.setEnabled(false); // set to default
			...
			for (Object condition : elem.getPreconditions()) {
				if (null != condition)
					((urncore.Condition) condition).setScenarioDefPre(elem);
			}
			// elem.getPostconditions();
			for (Object condition : elem.getPostconditions()) {
				if (null != condition)
					((urncore.Condition) condition).setScenarioDefPost(elem);
			}
