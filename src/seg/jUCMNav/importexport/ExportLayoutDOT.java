...
public class ExportLayoutDOT implements IUseCaseMapExport {
	...
	/**
	 * Returns a string representation of a Graphviz dot file format which
	 * includes the layout information for our use case map.
	 * 
	 * @param map
	 ...
	 * (non-Javadoc)
	 * 
	 * @see seg.jUCMNav.extensionpoints.IUseCaseMapExport#export(org.eclipse.draw2d.IFigure,
	 ...
	 * 
	 * @see seg.jUCMNav.extensionpoints.IUseCaseMapExport#export(IURNDiagram,
	 *      java.io.FileOutputStream)
	 */
