...
public class ParseException extends Exception {
    ...
    public String getMessage() {
        ...
        String retval = Messages.getString("ParseException.EncounteredQuote"); //$NON-NLS-1$
        ...
        retval += Messages.getString("ParseException.QuoteAtLine") + currentToken.next.beginLine + Messages.getString("ParseException.CommaColumn") + currentToken.next.beginColumn; //$NON-NLS-1$ //$NON-NLS-2$
        retval += Messages.getString("ParseException.Period") + eol; //$NON-NLS-1$
        if (expectedTokenSequences.length == 1) {
            retval += Messages.getString("ParseException.WasExpectingColon") + eol + "    "; //$NON-NLS-1$ //$NON-NLS-2$
        } else {
            retval += Messages.getString("ParseException.WasExpectingOneOf") + eol + "    "; //$NON-NLS-1$ //$NON-NLS-2$
        }
        retval += expected;
        return retval;
    }
