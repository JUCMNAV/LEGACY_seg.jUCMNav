...
public interface ITraversalListener {
     ...
     * @param becauseOfCondition because of a condition (true) or because of a path arrival (false)
     */
    ...
    /**
     * While traversing, a certain thread died. It might be merged into something else, see {@link #threadsMerged(List, int)} and {@link #threadSplit(int, List)}
     * 
     ...
     * 
     * @param oldThreadIDs a list of Integers, reprensenting dead thread ids. 
     ...
     * @param becauseOfCondition because of a condition (true) or because was forced to timeout (false) 
     */
