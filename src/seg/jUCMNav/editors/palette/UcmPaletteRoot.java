...
public class UcmPaletteRoot extends PaletteRoot {
    ...
    public UcmPaletteRoot() {
        ...
        entry = new CombinedTemplateCreationEntry("Team", "Create a team", ComponentRef.class,
                ...
                ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/spacer24.gif"));
        ...
        // ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/Object16.gif"), ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/spacer24.gif"));
        //		componentsDrawer.add(entry);
        //        entry = new CombinedTemplateCreationEntry("Process", "Create a process", null, new ModelCreationFactory(null),
        // ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/Process16.gif"), ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/spacer24.gif"));
        //		componentsDrawer.add(entry);
        //        entry = new CombinedTemplateCreationEntry("ISR", "Create an ISR", null, new ModelCreationFactory(null),
        // ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/ISR16.gif"), ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/spacer24.gif"));
        //		componentsDrawer.add(entry);
        //        entry = new CombinedTemplateCreationEntry("Pool", "Create a pool", null, new ModelCreationFactory(null),
        // ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/Pool16.gif"), ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/spacer24.gif"));
        //		componentsDrawer.add(entry);
        //        entry = new CombinedTemplateCreationEntry("Agent", "Create an agent", null, new ModelCreationFactory(null),
        // ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/Agent16.gif"), ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/spacer24.gif"));
        //		componentsDrawer.add(entry);
        entry = new CombinedTemplateCreationEntry("Other", "Create an other component", ComponentRef.class, new ModelCreationFactory(ComponentRef.class,
                ComponentKind.OTHER), ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/Component16.gif"), ImageDescriptor.createFromFile(
                JUCMNavPlugin.class, "icons/spacer24.gif"));
        componentsDrawer.add(entry);
        //		
        ...
        entry = new CombinedTemplateCreationEntry("StartPoint", "Creates a path", StartPoint.class, new ModelCreationFactory(StartPoint.class), ImageDescriptor
                .createFromFile(JUCMNavPlugin.class, "icons/Start16.gif"), ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/spacer24.gif"));
        componentsDrawer.add(entry);
        entry.setId("StartPoint");

        entry = new CombinedTemplateCreationEntry("Node", "Creates an empty node", EmptyPoint.class, new ModelCreationFactory(EmptyPoint.class),
        ...
        endPointTool = new CombinedTemplateCreationEntry("End Point", "Creates an end point", EndPoint.class, new ModelCreationFactory(EndPoint.class),
