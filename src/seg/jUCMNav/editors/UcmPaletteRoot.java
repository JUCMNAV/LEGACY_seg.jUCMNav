...
public class UcmPaletteRoot extends PaletteRoot {
    ...
    public UcmPaletteRoot() {
        ...
        entry = new CombinedTemplateCreationEntry("Team", "Create a team", ComponentRef.class, new ModelCreationFactory(ComponentRef.class, ComponentKind.TEAM), ImageDescriptor
                .createFromFile(JUCMNavPlugin.class, "icons/Component16.gif"), null);
        ...
        //		componentsDrawer.add(entry);
        entry = new CombinedTemplateCreationEntry("Other", "Create an other component", ComponentRef.class, new ModelCreationFactory(ComponentRef.class, ComponentKind.OTHER),
                ImageDescriptor.createFromFile(JUCMNavPlugin.class, "icons/Component16.gif"), null);
        componentsDrawer.add(entry);
        //		
