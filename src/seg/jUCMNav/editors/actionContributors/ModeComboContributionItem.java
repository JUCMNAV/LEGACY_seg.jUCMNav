...
public class ModeComboContributionItem extends ContributionItem {
    ...
    /**
     * The control item implementation of this <code>IContributionItem</code> method calls the <code>createControl</code> framework method to create a
     * control under the given parent, and then creates a new tool item to hold it. Subclasses must implement <code>createControl</code> rather than
