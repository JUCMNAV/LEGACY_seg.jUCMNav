...
/**
 * Creates a combo box to be used in the toolbars to select a view mode for a
 * use case map editor. Complete rip of ZoomComboContributionItem, with a few
 * changes.
 * 
 * @author jkealey
 */
public class ModeComboContributionItem extends ContributionItem {
	...
	/**
	 * @return do changes impact only the currently opened editor or does it
	 *         affect all of them?
	 */
	 ...
	 * 
	 * @param local
	 *            do changes impact only the currently opened editor or does it
	 *            affect all of them?
	 */
