...
/**
 * CompoundCommand to add a concern, first creates the concern and then assigns the concern to 
 * all of its diagrams 
 * @author gunterm
 */
public class CreateConcernCommand extends CompoundCommand {
	...
	/**
	 * @param urn URNspec to which to add the concern
	 * @param name of the concern
	 * @param description of the concern
	 * @param diagrams IURNDiagrams of the concern
	 */
