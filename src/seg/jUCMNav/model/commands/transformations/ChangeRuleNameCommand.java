 ...
 * @author jkealey
 */
public class ChangeRuleNameCommand extends Command implements JUCMNavCommand {
    ...
    public ChangeRuleNameCommand(Rule lbl, String name,ASDiagram asdiagram) {
        this.lbl = lbl;
        this.asdiagram=asdiagram;
        this.spec=lbl.getAsdSpec();
        this.elem= lbl;
        this.name = name;
        setLabel(Messages.getString("ChangeRuleNameCommand.changeRuleName")); //$NON-NLS-1$
    }
	...
	ArrayList al = new ArrayList(); 
        	...
        	for(Object el: spec.getOutcomes())
        	{
        		if(el instanceof Outcome && !al.contains(el)) //always true
        		{
        			...
        			{
        				((Rule) elem).getRequiredOutcomes().add(el);
        	...
        	for(Object el: spec.getOutcomes())
        	{
        		if(el instanceof Outcome && !al.contains(el)) //always true
        		{
        			...
        			{
        				((Rule) elem).getRequiredOutcomes().remove(el);
