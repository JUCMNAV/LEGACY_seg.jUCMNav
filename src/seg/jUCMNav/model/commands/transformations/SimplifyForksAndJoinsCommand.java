...
public class SimplifyForksAndJoinsCommand extends CompoundCommand {
	...
	/**
	 * Given a vector of NodeConnections associated to an AndFork, will move the branches onto a new AndFork which
	 * will be inserted on the first NodeConnection given in the vector. 
	 * 
	 * @param andfork the original andfork 
	 * @param v the vector of nodeconnections to move off. 
	 */
	...
	/**
	 * Given a vector of NodeConnections associated to an AndJoin, will move the branches onto a new AndJoin which
	 * will be inserted on the first NodeConnection given in the vector. 
	 * 
	 * @param andjoin the original andjoin 
	 * @param v the vector of nodeconnections to move off. 
	 */
	 ...
	 * 
	 * @param map the map containing and forks. 
	 */
