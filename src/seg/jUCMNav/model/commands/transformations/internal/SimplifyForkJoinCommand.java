...
public class SimplifyForkJoinCommand extends Command implements JUCMNavCommand {
     ...
     * @param forkOrJoin the andfork/andjoin; assumes it was already deleted before this command is executed but not when it is created. 
     * @param hmForkToNodeConnection a map that groups the fork/joins out/in branches by a flow point later/earlier on the path.  
     */
    ...
    public void testPostConditions() {
        assert forkOrJoin!=null && (forkOrJoin instanceof AndFork || forkOrJoin instanceof AndJoin) && forkOrJoin.getDiagram() == null;  //make sure was deleted first.
        assert map!=null;
