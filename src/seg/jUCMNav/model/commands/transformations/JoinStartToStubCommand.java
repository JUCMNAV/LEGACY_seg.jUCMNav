 ...
 * Created 27-05-2005
 * 
 * This command represents the action of a user dragging a StartPoint in a Stub. This action will erase the StartPoint and add the path as a
 * successor of the stub.
 * 
