 ...
 * Created 27-05-2005
 * 
 * This command represents the action of a user dragging an EndPoint in a Stub. This action will erase the EndPoint and add the path as a
 * predecessor of the Stub.
 * 
...
public class JoinEndToStubCommand extends Command implements JUCMNavCommand {
    ...
    public void testPostConditions() {
        ...
        assert ncOldEnd.getSource() == stub : "post connection source is the stub"; //$NON-NLS-1$
