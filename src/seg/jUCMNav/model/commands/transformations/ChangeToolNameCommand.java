 ...
 * @author jkealey
 */
public class ChangeToolNameCommand extends Command implements JUCMNavCommand {
    ...
    public ChangeToolNameCommand(Tool lbl, String name,ASDiagram asdiagram) {
        this.lbl = lbl;
        spec=lbl.getAsdSpec();
        this.elem= lbl;
        this.asdiagram=asdiagram;
        this.name = name;
        setLabel(Messages.getString("ChangeToolNameCommand.changeToolName")); //$NON-NLS-1$
    }
        ...
        if(elem instanceof Tool)
    	{
        	...
        	for(Object el: spec.getOutcomes())
        	{
        		if(el instanceof Outcome && !al.contains(el)) //always true
        		{
        			...
        			{
        				((Tool) elem).getRequiredOutcomes().add(el);
        	...
        	for(Object el: spec.getOutcomes())
        	{
        		if(el instanceof Outcome && !al.contains(el)) //always true
        		{
        			...
        			{
        				((Tool) elem).getRequiredOutcomes().remove(el);
