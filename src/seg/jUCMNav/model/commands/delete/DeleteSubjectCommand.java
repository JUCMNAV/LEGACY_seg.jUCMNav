...
import urn.URNspec;
    ...
    for(Object o: subject.getRequiredOutcomes())
    {
    	subject.getRequiredOutcomes().remove((Outcome)o);
    }
        ...
        public void undo() {
         	...
         	{
         		if(o instanceof Outcome && ((Outcome) o).getName().equals(subject.getName()) && !asDiagram.getElements().contains(o))
         		{
         			subject.getRequiredOutcomes().add(o);
         		}
         	}
