...
/**
 * Disconnect a GRLNode from all the connection associate to it. 
 * Used in delete of IntentionalElementRef and Belief. Add command to delete all the linkref
...
public class DisconnectGRLNodeCommand extends CompoundCommand {
    ...
    /**
     * @param element
     *          IntentionalElementRef to disconnect from LinkRef
     */
