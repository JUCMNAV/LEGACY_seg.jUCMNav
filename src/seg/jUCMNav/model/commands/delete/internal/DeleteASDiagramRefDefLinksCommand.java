 ...
 * 
 */
public class DeleteASDiagramRefDefLinksCommand extends CompoundCommand {
     ...
     *            the graph to delete
     */
    public DeleteASDiagramRefDefLinksCommand(ASDiagram diagram) {
        this.graph = diagram;
        setLabel("DeleteASDiagramRefDefLinksCommand"); //$NON-NLS-1$
    }
    ...
    private void build() {
        ...
        add(new RemoveASDiagramCommand(graph));
    }
