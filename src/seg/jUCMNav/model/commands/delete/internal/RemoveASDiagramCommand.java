 ...
 * 
 */
public class RemoveASDiagramCommand extends Command implements JUCMNavCommand {

    private ASDiagram diagram;
    private URNspec urn;
    private int position;

    public RemoveASDiagramCommand(ASDiagram graph) {
        setLabel("Remove ASDiagram"); //$NON-NLS-1$
        diagram = graph;
    }
