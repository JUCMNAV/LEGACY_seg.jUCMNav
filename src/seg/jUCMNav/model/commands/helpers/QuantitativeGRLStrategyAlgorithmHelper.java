...
import seg.jUCMNav.strategies.PropagationGRLStrategyAlgorithm;
...
public class QuantitativeGRLStrategyAlgorithmHelper extends PropagationGRLStrategyAlgorithmHelper implements IGRLStrategyAlgorithm {
    ...
    protected Integer preGetEvaluation(IntentionalElement element, Evaluation eval) {
        ...
        EvaluationStrategyManagerHelper strategyManager = EvaluationStrategyManagerHelper.getInstance();
    ...
    protected double computeContributionResult(ElementLink link, Contribution contrib) {
        int quantitativeContrib = EvaluationStrategyManagerHelper.getInstance().getActiveQuantitativeContribution(contrib);
