...
public class ModelCreationFactoryHelper {
     ...
     */
    public ModelCreationFactoryHelper(URNspec urn, Class targetClass) {
        this.urn = urn;
     ...
     */
    public ModelCreationFactoryHelper(URNspec urn, Class targetClass, Object definition) {
        this.urn = urn;
        this.targetClass = targetClass;
        this.type = 0;
     ...
     */
    public ModelCreationFactoryHelper(URNspec urn, Class targetClass, int type) {
        this.urn = urn;
        this.targetClass = targetClass;
        this.type = type;
    }
     ...
     *            the reference, it will use the one that is passed in.
     */
    public ModelCreationFactoryHelper(URNspec urn, Class targetClass, int type, Object definition) {
        this.urn = urn;
        this.targetClass = targetClass;
        this.type = type;
        this.preDefinedDefinition = definition;
    ...
    public static Object getNewObject(URNspec urn, Class targetClass, int type, Object definition) {
        ...
        if (targetClass != null) {
            ...
            //    comment.setFillColor(StringConverter.asString(ColorManager.FILL_COMMENTS.getRGB()));
                ...
                ((EvaluationStrategy) result).setAuthor("TouchRAM");
