...
public class AddLinkRefCommandHelper implements Command {
    IURNDiagram graph;
     ...
     * 
     */
    public AddLinkRefCommandHelper(IURNDiagram graph, IntentionalElementRef source, IntentionalElementRef destination, ElementLink link) {
        this.graph = graph;
        this.source = source;
