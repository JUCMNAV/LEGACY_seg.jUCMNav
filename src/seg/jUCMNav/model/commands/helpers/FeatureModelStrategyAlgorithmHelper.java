...
public class FeatureModelStrategyAlgorithmHelper extends FormulaBasedGRLStrategyAlgorithmHelper {
    ...
    public int getEvaluation(IntentionalElement element) {
        ...
        if (quickReturn != null && incomingLinks) {
            if (result != quickReturn.intValue()) {
                ...
                MetadataHelperHelper.addMetaData(element.getGrlspec().getUrnspec(), element, METADATA_WARNING, 
                ...
                MetadataHelperHelper.removeMetaData(element, METADATA_WARNING);
            }
        } else {
