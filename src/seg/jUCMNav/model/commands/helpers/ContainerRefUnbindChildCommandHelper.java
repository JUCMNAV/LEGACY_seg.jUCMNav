...
public class ContainerRefUnbindChildCommandHelper implements Command {
     ...
     */
    public ContainerRefUnbindChildCommandHelper(IURNContainerRef parent, URNmodelElement child) {
        this.parent = parent;
  ...
  //      setLabel(Messages.getString("ContainerRefUnbindChildCommand.unbindContainerReference")); //$NON-NLS-1$
     ...
     */
    public ContainerRefUnbindChildCommandHelper(IURNContainerRef parent, List children) {
        this.parent = parent;
        this.children = new Vector();
