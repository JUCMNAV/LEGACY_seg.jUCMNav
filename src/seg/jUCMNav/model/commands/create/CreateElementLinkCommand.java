...
/**
 * This command create the decomposition, contribution or dependency 
 * and all the linkref in the graph where the source and destination 
 * element ref are.
 * 
...
public class CreateElementLinkCommand extends CompoundCommand {
    ...
    /*
     * Find the pair of intentionalElementRef in the same GRLGraph corresponding to the source
     * and destination intentional element and add command to add LinkRef
     */
