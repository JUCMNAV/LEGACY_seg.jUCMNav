...
/***
 * This is not really a command but rather a utility to allow editing a node label without 
 * having to hit the escape key when the palette is selected. We had to use a Command to make 
 * it work in the infrastructure, but there is no redo/undo logic. 
 * 
 * @author jkealey
 *
 */
