...
/**
 * This class is used to find an element in an instance of the meta model with a
 * particular ID. This ID is supposed to be unique.
 * 
 * @author jkealey
 * 
 */
public class URNElementFinder {
	...
	/**
	 * Given an ID, find what element it belongs to. Currently only scans
	 * component elements, responsibilities, maps, pathnodes and componentrefs.
	 * 
	...
	/**
	 * Given a name, find what element it belongs to. Can only find
	 * responsibility and component definitions by name. Will return component
	 * if both component and responsibility exist.
	 * 
	 * Has been extended to also look for diagrams by name, even if they are not
	 * currently constrained to be unique.
	 * 
	 * If not found, returns null.
	 * 
	 * @param urn
	...
	/**
	 * Given a URN spec, find the component element having the passed id or
	 * return null.
	 * 
	 * @param urn
	 * @param id
	...
	/**
	 * Given a URN spec, find the component element having the passed name or
	 * return null.
	 * 
	 * @param urn
	 * @param name
	...
	/**
	 * Given a URN spec, find the responsibility having the passed id or return
	 * null.
	 * 
	 * @param urn
	 * @param id
	...
	/**
	 * Given a URN spec, find the responsibility having the passed name or
	 * return null.
	 * 
	 * @param urn
	 * @param name
	...
	/**
	 * Given a map, find the component reference having the passed id or return
	 * null.
	 * 
	 * @param map
	 * @param id
	...
	/**
	 * Given a map, find the container reference having the passed id or return
	 * null.
	 * 
	 * @param map
	 * @param id
	 ...
	 * 
	 * Note that diagram names are not constrained to be unique. Will return the
	 * first occurence.
	 * 
	 * @param urn
	 * @param name
	...
	/**
	 * Given a collection of UCMmodelElements, return the oen having the passed
	 * id or return null.
	 * 
	 * @param c
	 * @param id
	...
	/**
	 * Given a map, find the NodeConnection connected to PathNodes with the
	 * specified ids.
	 * 
	 * @param map
	...
	/**
	 * Given a map, find the Connection connected to Nodes with the specified
	 * ids.
	 * 
	 * @param map
	 *            the map containing the connections.
