...
public class MetadataHelper {
     ...
     * @param model the URNspec instance
     */
    ...
    {
    	return (name==EvaluationStrategyManager.METADATA_NUMEVAL
		     || name==EvaluationStrategyManager.METADATA_QUALEVAL 
		     || name==PathNodeEditPart.METADATA_HITS
		     );
    }
}
