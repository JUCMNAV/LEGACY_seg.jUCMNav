...
public class EndPointImpl extends NodeImpl implements EndPoint {
	...
	protected EClass eStaticClass() {
		return UcmPackage.eINSTANCE.getEndPoint();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case UcmPackage.END_POINT__COMPONENT:
					if (component != null)
						msgs = ((InternalEObject)component).eInverseRemove(this, UcmPackage.COMPONENT__ELEMENTS, Component.class, msgs);
					return basicSetComponent((Component)otherEnd, msgs);
				case UcmPackage.END_POINT__DIAGRAM:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, UcmPackage.END_POINT__DIAGRAM, msgs);
				case UcmPackage.END_POINT__UP_LINK:
					if (upLink != null)
				...
				case UcmPackage.END_POINT__DOWN_LINK:
					if (downLink != null)
				...
				case UcmPackage.END_POINT__PATH:
					if (path != null)
				...
				case UcmPackage.END_POINT__NEXT:
					if (next != null)
				...
				case UcmPackage.END_POINT__PREVIOUS:
					if (previous != null)
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				...
				case UcmPackage.END_POINT__DIAGRAM:
					return eBasicSetContainer(null, UcmPackage.END_POINT__DIAGRAM, msgs);
				case UcmPackage.END_POINT__UP_LINK:
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case UcmPackage.END_POINT__X:
				return new Integer(getX());
			case UcmPackage.END_POINT__Y:
