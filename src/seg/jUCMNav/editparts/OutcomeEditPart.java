...
import seg.jUCMNav.editpolicies.directEditPolicy.OutcomeDirectEditPolicy;
import seg.jUCMNav.editpolicies.element.OutcomeComponentEditPolicy;
import seg.jUCMNav.figures.ASDiagramBackgroundImage;
import seg.jUCMNav.figures.AsdTextEditor;
import seg.jUCMNav.figures.OutcomeFigure;
import seg.jUCMNav.figures.util.UrnMetadata;
import seg.jUCMNav.views.property.LabelPropertySource;
import urncore.URNmodelElement;


public class OutcomeEditPart extends ModelElementEditPart {
	// label padding
	...
	public OutcomeEditPart(ASDmodelElement model,ASDiagram asdDiagram) {
		super();
		setModel(model);
		modelElement= model;
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new OutcomeDirectEditPolicy());
	    installEditPolicy(EditPolicy.COMPONENT_ROLE, new OutcomeComponentEditPolicy());
	...
	protected IFigure createFigure() {
		...
		return new OutcomeFigure(asdSpec,(Outcome)modelElement);
	...
	private boolean directEditHitTest(Point requestLoc) {
		OutcomeFigure figure = (OutcomeFigure) getFigure();
	...
	public void handleNameChange(String value) {
		OutcomeFigure tableFigure = (OutcomeFigure) getFigure();
	...
	protected void refreshVisuals() {        
		...
		if (modelElement != null) {
			eraseTargetFeedback(new SelectionRequest());
			OutcomeFigure labelFigure = (OutcomeFigure) getNodeFigure();
