...
import seg.jUCMNav.editpolicies.directEditPolicy.SubjectDirectEditPolicy;
import seg.jUCMNav.editpolicies.element.SubjectComponentEditPolicy;
import seg.jUCMNav.figures.ASDiagramBackgroundImage;
import seg.jUCMNav.figures.AsdTextEditor;
import seg.jUCMNav.figures.SubjectFigure;
import seg.jUCMNav.figures.util.UrnMetadata;
import seg.jUCMNav.views.property.LabelPropertySource;
import urncore.URNmodelElement;


public class SubjectEditPart extends ModelElementEditPart {
	// label padding
	...
	public SubjectEditPart(ASDmodelElement model,ASDiagram asdDiagram) {
		super();
		setModel(model);
		modelElement= model;
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new SubjectDirectEditPolicy(asdDiagram));
		installEditPolicy(EditPolicy.COMPONENT_ROLE, new SubjectComponentEditPolicy());
		//installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ToolFeedbackEditPolicy());
	...
	protected IFigure createFigure() {
		...
		return new SubjectFigure(asdSpec,(Subject)modelElement,asdDiagram);
	...
	public void handleNameChange(String value) {
		SubjectFigure tableFigure = (SubjectFigure) getFigure();
	...
	protected void refreshVisuals() {        
		...
		if (modelElement != null) {
			eraseTargetFeedback(new SelectionRequest());
			SubjectFigure labelFigure = (SubjectFigure) getNodeFigure();
