 ...
 */
public abstract class SpecificationDiagramEditPart extends ModelElementEditPart {
     ...
     */
    public SpecificationDiagramEditPart(SpecificationDiagram diagram) {
        setModel(diagram);
    }
    ...
    protected void addChild(EditPart child, int index) {
        ...
        int i = index;
        if (child.getModel() instanceof SpecificationComponentRef)
    ...
    protected void addChildVisual(EditPart childEditPart, int index) {
        if (!(childEditPart.getModel() instanceof SpecificationComponentRef)) {
    ...
    protected List getComponentEditParts() {
        ...
        for (Iterator j = children.iterator(); j.hasNext();) {
            ...
            if (edit.getModel() instanceof SpecificationComponentRef)
                comps.add(edit);
        }
    ...
    public IFigure getContentPane() {
        if (editPartInProcess != null) {
            if (editPartInProcess.getModel() instanceof SpecificationComponentRef)
     ...
     */
    protected SpecificationDiagram getDiagram() {
        return (SpecificationDiagram) getModel();
    }
    ...
    protected List getSpecificationNodeEditParts() {
        ...
        for (Iterator j = children.iterator(); j.hasNext();) {
            EditPart edit = (EditPart) j.next();
            if (edit.getModel() instanceof SpecificationNode)
                nodes.add(edit);
        }
    ...
    public void refreshChildren() {
        ...
        for (i = 0; i < modelObjects.size(); i++) {
            ...
            if (!(model instanceof SpecificationComponentRef)) {
            ...
            if (editPart != null) {
                ...
                if (editPart.getModel() instanceof SpecificationComponentRef)
