...
import asd.Tool;
import seg.jUCMNav.editpolicies.directEditPolicy.AimDirectEditPolicy;
...
import seg.jUCMNav.editpolicies.element.AimComponentEditPolicy;
import seg.jUCMNav.figures.ASDiagramBackgroundImage;
import seg.jUCMNav.figures.AimFigure;
...
public class AimEditPart extends ModelElementEditPart {
	// label padding
	...
	public AimEditPart(ASDmodelElement model,ASDiagram asdDiagram) {
		super();
		setModel(model);
		modelElement= model;
	...
	protected void createEditPolicies() {
		...
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new AimDirectEditPolicy(asdDiagram));
	   installEditPolicy(EditPolicy.COMPONENT_ROLE, new AimComponentEditPolicy());
	...
	protected IFigure createFigure() {
		...
		return new AimFigure(asdSpec,(Aim)modelElement,asdDiagram);
	...
	private boolean directEditHitTest(Point requestLoc) {
		AimFigure figure = (AimFigure) getFigure();
	...
	public void handleNameChange(String value) {
		AimFigure tableFigure = (AimFigure) getFigure();
	...
	protected void refreshVisuals() {        
		...
		if (modelElement != null) {
			eraseTargetFeedback(new SelectionRequest());
			AimFigure labelFigure = (AimFigure) getNodeFigure();
