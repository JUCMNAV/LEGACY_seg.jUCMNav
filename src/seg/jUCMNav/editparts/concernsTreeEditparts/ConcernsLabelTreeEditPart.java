...
/**
 * TreeEditPart for a label in the Concern Outline. Only two labels exists in this context. 
 * They are used as a group for root maps/GRL graphs without concerns and as a group for 
 * recursive maps that are not shown anywhere else in the outline.
 * @author gunterm
 */
public class ConcernsLabelTreeEditPart extends LabelTreeEditPart {
	...
	/**
	 * @param model is a String containing the name of the group
	 * @param root is the edited URNspec
	 */
    ...
    /**
     * @return the sorted list of diagrams in the group
     * either root maps and GRL graphs that do not have a concern or recursive maps (these are maps 
     * that are part of an infinite loop because a map is included in itself either directly or indirectly) 
	...
	/**
	 * deal with a special case: maps that contain each other recursively either directly or 
	 * indirectly (they need to be included if they are not already shown in the outline)
	...
	/**
	 * removes the model of the editPart from the list if it is contained in the list, then
	 * continues recursively with the children of the editPart
	 * @param editPart of the outline that is visited recursively
	 * @param list of maps that are possibly not shown in the outline
	 */
    ...
    /**
     * When concerns are added or removed from the URNdefinition, start/stop listening to the concern.
     * When maps are added or removed from the URNdefinition, start/stop listening to the map. 
	...
	/**
	 * ensures that the list of observed concerns matches the current list of concerns in the model,
	 * adds new concerns and starts listening to them,
	 * removes deleted concerns and stops listening to them
	 */
	...
	/**
	 * ensures that the list of observed maps matches the current list of maps in the model,
	 * adds new maps and starts listening to them,
	 * removes deleted maps and stops listening to them 
	 */
	 ...
	 * @param observed is either the list of Concerns or the list of UCMmaps
	 */
