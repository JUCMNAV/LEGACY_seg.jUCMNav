 ...
 */
public class DiagramTreeEditPart extends UrnModelElementTreeEditPart {

    /**
     * @param model
     *            the map
     */
    public DiagramTreeEditPart(ASDiagram model) {
        super(model);
    }
     ...
     */
    protected ASDiagram getMap() {
        return ((ASDiagram) getModel());
    }
