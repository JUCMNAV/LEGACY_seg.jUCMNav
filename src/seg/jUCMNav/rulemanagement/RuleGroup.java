...
public class RuleGroup {
   ...
   public RuleGroup(String name)
     ...
     * @param rule  a static checking rule
     * @see Rule
     */
     ...
     * @param rules a bunch of rules, the content of the list must be type of Rule or its inheritence.
     * @see Rule
     */
     ...
     * @param bEnable   true to enable rules, false to disable rules.
     */
