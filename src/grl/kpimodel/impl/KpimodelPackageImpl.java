...
public class KpimodelPackageImpl extends EPackageImpl implements KpimodelPackage {
    ...
    public static KpimodelPackage init() {
        ...
        KpimodelPackageImpl theKpimodelPackage = (KpimodelPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof KpimodelPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new KpimodelPackageImpl());
