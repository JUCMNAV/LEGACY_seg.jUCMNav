...
public interface GrlPackage extends EPackage {
     ...
     * @ordered
     */
    int GR_LSPEC__KPI_INFORMATION_ELEMENTS = 6;
     ...
     * @ordered
     */
    int GR_LSPEC__KPI_MODEL_LINKS = 7;
     ...
     * @ordered
     */
    int GR_LSPEC__INDICATOR_GROUP = 8;
     ...
     * @ordered
     */
    int EVALUATION__KPI_EVAL_VALUE_SET = 3;
     ...
     * @ordered
     */
    int EVALUATION_STRATEGY__KPI_INFO_CONFIG = UrncorePackage.GR_LMODEL_ELEMENT_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
    int EVALUATION_STRATEGY_FEATURE_COUNT = UrncorePackage.GR_LMODEL_ELEMENT_FEATURE_COUNT + 5;
