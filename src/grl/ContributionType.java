...
public final class ContributionType extends AbstractEnumerator {
     ...
     * @ordered
     */
    public static final int SOME_NEGATIVE = 2;
     ...
     * @ordered
     */
    public static final int SOME_POSITIVE = 5;
     ...
     * @ordered
     */
    public static final int MAKE = 7;
     ...
     * @ordered
     */
    public static final ContributionType SOME_NEGATIVE_LITERAL = new ContributionType(SOME_NEGATIVE, "SomeNegative");
     ...
     * @ordered
     */
    public static final ContributionType UNKNOWN_LITERAL = new ContributionType(UNKNOWN, "Unknown");
     ...
     * @ordered
     */
    public static final ContributionType EQUAL_LITERAL = new ContributionType(EQUAL, "Equal");
     ...
     * @ordered
     */
    public static final ContributionType SOME_POSITIVE_LITERAL = new ContributionType(SOME_POSITIVE, "SomePositive");
