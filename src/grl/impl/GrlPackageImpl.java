...
public class GrlPackageImpl extends EPackageImpl implements GrlPackage {
    ...
    public void initializePackageContents() {
		...
		initEAttribute(getContribution_QuantitativeContribution(), ecorePackage.getEInt(), "quantitativeContribution", "0", 0, 1, Contribution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
