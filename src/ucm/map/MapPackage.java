...
public interface MapPackage extends EPackage{
     ...
     * @ordered
     */
	int PATH_NODE__PATH_GRAPH = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
	int PATH_NODE__SUCC = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
	int PATH_NODE__PRED = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
	int PATH_NODE__COMP_REF = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 5;
     ...
     * @ordered
     */
	int AND_JOIN__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int RESP_REF__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int LOOP__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int OR_JOIN__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int OR_FORK__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int CONNECT__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int NODE_CONNECTION__PATH_GRAPH = 1;
     ...
     * @ordered
     */
	int NODE_CONNECTION__IN_BINDINGS = 4;
     ...
     * @ordered
     */
	int NODE_CONNECTION__OUT_BINDINGS = 5;
     ...
     * @ordered
     */
	int NODE_CONNECTION__CONDITION = 6;
     ...
     * @ordered
     */
	int NODE_CONNECTION_FEATURE_COUNT = 7;
     ...
     * @ordered
     */
	int WAITING_PLACE__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int STUB__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int END_POINT__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int START_POINT__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int MAP__UCMSPEC = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
	int PATH_GRAPH_FEATURE_COUNT = 3;
     ...
     * @ordered
     */
	int ABORT__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int COMPONENT_REF__MAP = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 8;
     ...
     * @ordered
     */
	int COMPONENT_REF__COMP_DEF = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 9;
     ...
     * @ordered
     */
	int COMPONENT_REF__PARENT = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 11;
     ...
     * @ordered
     */
	int COMPONENT_REF__PATH_NODES = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 12;
     ...
     * @ordered
     */
	int COMPONENT_REF__LABEL = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 13;
     ...
     * @ordered
     */
	int TIMER__PATH_GRAPH = WAITING_PLACE__PATH_GRAPH;
     ...
     * @ordered
     */
	int AND_FORK__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int EMPTY_POINT__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int FAILURE_POINT__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
     ...
     * @ordered
     */
	int DIRECTION_ARROW__PATH_GRAPH = PATH_NODE__PATH_GRAPH;
    ...
    /**
     * Returns the meta object for the container reference '{@link ucm.map.NodeConnection#getPathGraph <em>Path Graph</em>}'.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @return the meta object for the container reference '<em>Path Graph</em>'.
     * @see ucm.map.NodeConnection#getPathGraph()
     * @see #getNodeConnection()
     * @generated
     */
	EReference getNodeConnection_PathGraph();
    ...
    /**
     * Returns the meta object for the container reference '{@link ucm.map.PathNode#getPathGraph <em>Path Graph</em>}'.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @return the meta object for the container reference '<em>Path Graph</em>'.
     ...
     * @generated
     */
	EReference getPathNode_PathGraph();
    ...
    /**
     * Returns the meta object for the container reference '{@link ucm.map.Map#getUcmspec <em>Ucmspec</em>}'.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
    ...
    /**
     * Returns the meta object for the container reference '{@link ucm.map.PathGraph#getMap <em>Map</em>}'.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
    ...
    /**
     * Returns the meta object for the container reference '{@link ucm.map.ComponentRef#getMap <em>Map</em>}'.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @return the meta object for the container reference '<em>Map</em>'.
     ...
     * @generated
     */
	EReference getComponentRef_Map();
