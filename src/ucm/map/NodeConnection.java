 ...
 *   <li>{@link ucm.map.NodeConnection#getPathGraph <em>Path Graph</em>}</li>
...
public interface NodeConnection extends EObject{
     ...
     * It is bidirectional and its opposite is '{@link ucm.map.PathGraph#getNodeConnections <em>Node Connections</em>}'.
     * <!-- begin-user-doc -->
	 * <p>
     ...
     * @see ucm.map.MapPackage#getNodeConnection_PathGraph()
     * @see ucm.map.PathGraph#getNodeConnections
     * @model opposite="nodeConnections" required="true"
     * @generated
     */
	PathGraph getPathGraph();

    /**
     * Sets the value of the '{@link ucm.map.NodeConnection#getPathGraph <em>Path Graph</em>}' container reference.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
