 ...
 *   <li>{@link ucm.map.ComponentRef#getLabelX <em>Label X</em>}</li>
 *   <li>{@link ucm.map.ComponentRef#getLabely <em>Labely</em>}</li>
...
public interface ComponentRef extends UCMmodelElement {
	 ...
	 * @see #setLabelX(int)
	 * @see ucm.map.MapPackage#getComponentRef_LabelX()
	 * @model 
	 * @generated
	 */
	int getLabelX();
	...
	/**
	 * Sets the value of the '{@link ucm.map.ComponentRef#getLabelX <em>Label X</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Labely</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Labely</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Labely</em>' attribute.
	 * @see #setLabely(int)
	 * @see ucm.map.MapPackage#getComponentRef_Labely()
	 * @model 
	 * @generated
	 */
	int getLabely();
	...
	/**
	 * Sets the value of the '{@link ucm.map.ComponentRef#getLabely <em>Labely</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Labely</em>' attribute.
	 * @see #getLabely()
	 * @generated
	 */
