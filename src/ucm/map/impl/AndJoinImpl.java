...
public class AndJoinImpl extends PathNodeImpl implements AndJoin {
    ...
    protected EClass eStaticClass() {
        return MapPackage.eINSTANCE.getAndJoin();
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                case MapPackage.AND_JOIN__URN_LINKS:
                    return ((InternalEList)getUrnLinks()).basicAdd(otherEnd, msgs);
                case MapPackage.AND_JOIN__SPEC_DIAGRAM:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, MapPackage.AND_JOIN__SPEC_DIAGRAM, msgs);
                case MapPackage.AND_JOIN__COMP_REF:
                    if (compRef != null)
                ...
                case MapPackage.AND_JOIN__SUCC:
                    return ((InternalEList)getSucc()).basicAdd(otherEnd, msgs);
                case MapPackage.AND_JOIN__PRED:
                    return ((InternalEList)getPred()).basicAdd(otherEnd, msgs);
                case MapPackage.AND_JOIN__LABEL:
                    if (label != null)
                        msgs = ((InternalEObject)label).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MapPackage.AND_JOIN__LABEL, null, msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case MapPackage.AND_JOIN__SPEC_DIAGRAM:
                    return eBasicSetContainer(null, MapPackage.AND_JOIN__SPEC_DIAGRAM, msgs);
                case MapPackage.AND_JOIN__COMP_REF:
