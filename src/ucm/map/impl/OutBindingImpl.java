...
public class OutBindingImpl extends EObjectImpl implements OutBinding {
	...
	public void setBinding(PluginBinding newBinding) {
		if (newBinding != eContainer || (eContainerFeatureID != MapPackage.OUT_BINDING__BINDING && newBinding != null)) {
		...
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case MapPackage.OUT_BINDING__BINDING:
					if (eContainer != null)
						msgs = eBasicRemoveFromContainer(msgs);
					return eBasicSetContainer(otherEnd, MapPackage.OUT_BINDING__BINDING, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
		if (featureID >= 0) {
			switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
				case MapPackage.OUT_BINDING__BINDING:
					return eBasicSetContainer(null, MapPackage.OUT_BINDING__BINDING, msgs);
				case MapPackage.OUT_BINDING__END_POINT:
	...
	public NotificationChain eBasicRemoveFromContainer(NotificationChain msgs) {
		if (eContainerFeatureID >= 0) {
			switch (eContainerFeatureID) {
				case MapPackage.OUT_BINDING__BINDING:
					return ((InternalEObject)eContainer).eInverseRemove(this, MapPackage.PLUGIN_BINDING__OUT, PluginBinding.class, msgs);
				default:
