        ...
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case MapPackage.DIRECTION_ARROW__PATH_GRAPH:
                    ...
                    return eBasicSetContainer(otherEnd, MapPackage.DIRECTION_ARROW__PATH_GRAPH, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case MapPackage.DIRECTION_ARROW__PATH_GRAPH:
                    return eBasicSetContainer(null, MapPackage.DIRECTION_ARROW__PATH_GRAPH, msgs);
                case MapPackage.DIRECTION_ARROW__SUCC:
