 ...
 *   <li>{@link ucm.map.impl.ComponentRefImpl#getSpecDiagram <em>Spec Diagram</em>}</li>
...
public class ComponentRefImpl extends UCMmodelElementImpl implements ComponentRef {
    ...
    public SpecificationDiagram getSpecDiagram() {
        if (eContainerFeatureID != MapPackage.COMPONENT_REF__SPEC_DIAGRAM) return null;
    ...
    public void setSpecDiagram(SpecificationDiagram newSpecDiagram) {
        if (newSpecDiagram != eContainer || (eContainerFeatureID != MapPackage.COMPONENT_REF__SPEC_DIAGRAM && newSpecDiagram != null)) {
            ...
            msgs = eBasicSetContainer((InternalEObject)newSpecDiagram, MapPackage.COMPONENT_REF__SPEC_DIAGRAM, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MapPackage.COMPONENT_REF__SPEC_DIAGRAM, newSpecDiagram, newSpecDiagram));
    }
    ...
    public EList getNodes() {
        if (nodes == null) {
            nodes = new EObjectWithInverseResolvingEList(SpecificationNode.class, this, MapPackage.COMPONENT_REF__NODES, UrncorePackage.SPECIFICATION_NODE__COMP_REF);
        }
        return nodes;
    }
    ...
    public EList getChildren() {
        if (children == null) {
            children = new EObjectWithInverseResolvingEList(SpecificationComponentRef.class, this, MapPackage.COMPONENT_REF__CHILDREN, UrncorePackage.SPECIFICATION_COMPONENT_REF__PARENT);
        }
        return children;
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case MapPackage.COMPONENT_REF__SPEC_DIAGRAM:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, MapPackage.COMPONENT_REF__SPEC_DIAGRAM, msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, Class baseClass, NotificationChain msgs) {
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case MapPackage.COMPONENT_REF__SPEC_DIAGRAM:
                    return eBasicSetContainer(null, MapPackage.COMPONENT_REF__SPEC_DIAGRAM, msgs);
                case MapPackage.COMPONENT_REF__COMP_DEF:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class baseClass) {
        if (baseClass == SpecificationComponentRef.class) {
            switch (derivedFeatureID) {
                case MapPackage.COMPONENT_REF__X: return UrncorePackage.SPECIFICATION_COMPONENT_REF__X;
                case MapPackage.COMPONENT_REF__Y: return UrncorePackage.SPECIFICATION_COMPONENT_REF__Y;
                case MapPackage.COMPONENT_REF__WIDTH: return UrncorePackage.SPECIFICATION_COMPONENT_REF__WIDTH;
                case MapPackage.COMPONENT_REF__HEIGHT: return UrncorePackage.SPECIFICATION_COMPONENT_REF__HEIGHT;
                case MapPackage.COMPONENT_REF__FIXED: return UrncorePackage.SPECIFICATION_COMPONENT_REF__FIXED;
                case MapPackage.COMPONENT_REF__SPEC_DIAGRAM: return UrncorePackage.SPECIFICATION_COMPONENT_REF__SPEC_DIAGRAM;
                case MapPackage.COMPONENT_REF__COMP_DEF: return UrncorePackage.SPECIFICATION_COMPONENT_REF__COMP_DEF;
                case MapPackage.COMPONENT_REF__NODES: return UrncorePackage.SPECIFICATION_COMPONENT_REF__NODES;
                case MapPackage.COMPONENT_REF__LABEL: return UrncorePackage.SPECIFICATION_COMPONENT_REF__LABEL;
                case MapPackage.COMPONENT_REF__PARENT: return UrncorePackage.SPECIFICATION_COMPONENT_REF__PARENT;
                case MapPackage.COMPONENT_REF__CHILDREN: return UrncorePackage.SPECIFICATION_COMPONENT_REF__CHILDREN;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass) {
        if (baseClass == SpecificationComponentRef.class) {
            switch (baseFeatureID) {
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__X: return MapPackage.COMPONENT_REF__X;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__Y: return MapPackage.COMPONENT_REF__Y;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__WIDTH: return MapPackage.COMPONENT_REF__WIDTH;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__HEIGHT: return MapPackage.COMPONENT_REF__HEIGHT;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__FIXED: return MapPackage.COMPONENT_REF__FIXED;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__SPEC_DIAGRAM: return MapPackage.COMPONENT_REF__SPEC_DIAGRAM;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__COMP_DEF: return MapPackage.COMPONENT_REF__COMP_DEF;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__NODES: return MapPackage.COMPONENT_REF__NODES;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__LABEL: return MapPackage.COMPONENT_REF__LABEL;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__PARENT: return MapPackage.COMPONENT_REF__PARENT;
                case UrncorePackage.SPECIFICATION_COMPONENT_REF__CHILDREN: return MapPackage.COMPONENT_REF__CHILDREN;
                default: return -1;
            }
        }
