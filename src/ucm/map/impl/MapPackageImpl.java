...
public class MapPackageImpl extends EPackageImpl implements MapPackage {
	 ...
	 * @generated
	 */
	public EReference getNodeConnection_PathGraph() {
	 ...
	 * @generated
	 */
	public EReference getPathNode_PathGraph() {
	...
	public EReference getPathNode_Succ() {
		return (EReference)pathNodeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getMap_Ucmspec() {
	 ...
	 * @generated
	 */
	public EReference getPathGraph_Map() {
		return (EReference)pathGraphEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getComponentRef_Map() {
	...
	public EReference getComponentRef_CompDef() {
		return (EReference)componentRefEClass.getEStructuralFeatures().get(9);
	}
	...
	public void createPackageContents() {
		...
		createEReference(nodeConnectionEClass, NODE_CONNECTION__PATH_GRAPH);
		...
		createEReference(pathNodeEClass, PATH_NODE__PATH_GRAPH);
		...
		createEReference(mapEClass, MAP__UCMSPEC);
		...
		createEReference(pathGraphEClass, PATH_GRAPH__MAP);
		...
		createEReference(componentRefEClass, COMPONENT_REF__MAP);
	...
	public void initializePackageContents() {
		...
		initEReference(getNodeConnection_PathGraph(), this.getPathGraph(), this.getPathGraph_NodeConnections(), "pathGraph", null, 1, 1, NodeConnection.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPathNode_PathGraph(), this.getPathGraph(), this.getPathGraph_PathNodes(), "pathGraph", null, 1, 1, PathNode.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPathNode_Label(), theUrncorePackage.getNodeLabel(), theUrncorePackage.getNodeLabel_PathNode(), "label", null, 0, 1, PathNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMap_PathGraph(), this.getPathGraph(), this.getPathGraph_Map(), "pathGraph", null, 0, 1, Map.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMap_CompRefs(), this.getComponentRef(), this.getComponentRef_Map(), "compRefs", null, 0, -1, Map.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMap_Ucmspec(), theUcmPackage.getUCMspec(), theUcmPackage.getUCMspec_Maps(), "ucmspec", null, 1, 1, Map.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPathGraph_PathNodes(), this.getPathNode(), this.getPathNode_PathGraph(), "pathNodes", null, 0, -1, PathGraph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPathGraph_NodeConnections(), this.getNodeConnection(), this.getNodeConnection_PathGraph(), "nodeConnections", null, 0, -1, PathGraph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPathGraph_Map(), this.getMap(), this.getMap_PathGraph(), "map", null, 1, 1, PathGraph.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getComponentRef_Map(), this.getMap(), this.getMap_CompRefs(), "map", null, 1, 1, ComponentRef.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getComponentRef_Label(), theUrncorePackage.getComponentLabel(), theUrncorePackage.getComponentLabel_CompRef(), "label", null, 1, 1, ComponentRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
