...
public final class DeviceKind extends AbstractEnumerator {
     ...
     * @ordered
     */
	public static final DeviceKind PROCESSOR_LITERAL = new DeviceKind(PROCESSOR, "Processor");
     ...
     * @ordered
     */
	public static final DeviceKind DISK_LITERAL = new DeviceKind(DISK, "Disk");
     ...
     * @ordered
     */
	public static final DeviceKind DSP_LITERAL = new DeviceKind(DSP, "DSP");
     ...
     * @ordered
     */
	public static final DeviceKind OTHER_LITERAL = new DeviceKind(OTHER, "Other");
     ...
     * @generated
     */
	public static DeviceKind get(String name) {
    ...
    /**
     * Returns the '<em><b>Device Kind</b></em>' literal with the specified value.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
     ...
     * @generated
     */
	private DeviceKind(int value, String name) {
        super(value, name);
    }
