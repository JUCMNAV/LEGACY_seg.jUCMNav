...
public class ResponseTimeReqImpl extends UCMmodelElementImpl implements ResponseTimeReq {
    ...
    protected EClass eStaticClass() {
        return PerformancePackage.eINSTANCE.getResponseTimeReq();
    }
    ...
    public void setUcmspec(UCMspec newUcmspec) {
        if (newUcmspec != eContainer || (eContainerFeatureID != PerformancePackage.RESPONSE_TIME_REQ__UCMSPEC && newUcmspec != null)) {
    ...
    public Timestamp getTs1() {
        if (ts1 != null && ts1.eIsProxy()) {
            ...
            ts1 = (Timestamp)eResolveProxy((InternalEObject)ts1);
            if (ts1 != oldTs1) {
                if (eNotificationRequired())
    ...
    public Timestamp getTs2() {
        if (ts2 != null && ts2.eIsProxy()) {
            ...
            ts2 = (Timestamp)eResolveProxy((InternalEObject)ts2);
            if (ts2 != oldTs2) {
                if (eNotificationRequired())
        ...
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case PerformancePackage.RESPONSE_TIME_REQ__UCMSPEC:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, PerformancePackage.RESPONSE_TIME_REQ__UCMSPEC, msgs);
