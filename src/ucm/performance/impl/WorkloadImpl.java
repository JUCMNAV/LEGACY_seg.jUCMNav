...
public class WorkloadImpl extends UCMmodelElementImpl implements Workload {
	...
	public void setStartPoint(StartPoint newStartPoint) {
        if (newStartPoint != eContainer || (eContainerFeatureID != PerformancePackage.WORKLOAD__START_POINT && newStartPoint != null)) {
        ...
        if (featureID >= 0) {
            switch (eDerivedStructuralFeatureID(featureID, baseClass)) {
                ...
                case PerformancePackage.WORKLOAD__START_POINT:
                    if (eContainer != null)
                        msgs = eBasicRemoveFromContainer(msgs);
                    return eBasicSetContainer(otherEnd, PerformancePackage.WORKLOAD__START_POINT, msgs);
