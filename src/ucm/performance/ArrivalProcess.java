...
public final class ArrivalProcess extends AbstractEnumerator {
     ...
     * @ordered
     */
	public static final ArrivalProcess POISSON_PDF_LITERAL = new ArrivalProcess(POISSON_PDF, "PoissonPDF");
     ...
     * @ordered
     */
	public static final ArrivalProcess PERIODIC_LITERAL = new ArrivalProcess(PERIODIC, "Periodic");
     ...
     * @ordered
     */
	public static final ArrivalProcess UNIFORM_LITERAL = new ArrivalProcess(UNIFORM, "Uniform");
     ...
     * @ordered
     */
	public static final ArrivalProcess PHASE_TYPE_LITERAL = new ArrivalProcess(PHASE_TYPE, "PhaseType");
     ...
     * @generated
     */
	public static ArrivalProcess get(String name) {
    ...
    /**
     * Returns the '<em><b>Arrival Process</b></em>' literal with the specified value.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     */
     ...
     * @generated
     */
	private ArrivalProcess(int value, String name) {
        super(value, name);
    }
