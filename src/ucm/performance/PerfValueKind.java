...
public final class PerfValueKind extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
    public static final PerfValueKind MEAN_LITERAL = new PerfValueKind(MEAN, "Mean", "Mean");
	 ...
	 * @ordered
	 */
    public static final PerfValueKind VARIANCE_LITERAL = new PerfValueKind(VARIANCE, "Variance", "Variance");
	 ...
	 * @ordered
	 */
    public static final PerfValueKind PERCENTILE_LITERAL = new PerfValueKind(PERCENTILE, "Percentile", "Percentile");
	 ...
	 * @ordered
	 */
    public static final PerfValueKind MOMENT_LITERAL = new PerfValueKind(MOMENT, "Moment", "Moment");
	 ...
	 * @ordered
	 */
    public static final PerfValueKind MIN_LITERAL = new PerfValueKind(MIN, "Min", "Min");
	 ...
	 * @ordered
	 */
    public static final PerfValueKind MAX_LITERAL = new PerfValueKind(MAX, "Max", "Max");
	 ...
	 * @ordered
	 */
    public static final PerfValueKind DISTRIBUTION_LITERAL = new PerfValueKind(DISTRIBUTION, "Distribution", "Distribution");
	 ...
	 * @ordered
	 */
    public static final PerfValueKind UNKNOWN_LITERAL = new PerfValueKind(UNKNOWN, "Unknown", "Unknown");
