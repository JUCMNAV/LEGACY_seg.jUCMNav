...
public interface ScenarioPackage extends EPackage {
     ...
     * @ordered
     */
    int SCENARIO_GROUP__SCENARIO_DEF = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int SCENARIO_GROUP_FEATURE_COUNT = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int SCENARIO_DEF_FEATURE_COUNT = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int VARIABLE__USAGES = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int VARIABLE_FEATURE_COUNT = UrncorePackage.UC_MMODEL_ELEMENT_FEATURE_COUNT + 2;
