...
public class ScenarioPackageImpl extends EPackageImpl implements ScenarioPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getVariable_Usages(), theMapPackage.getCondition(), theMapPackage.getCondition_Variables(), "usages", null, 0, -1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
